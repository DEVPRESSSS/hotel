    ...
    <div className="flex h-screen">
      ...
      <aside className="w-56 bg-gray-50 border-r border-gray-200 flex flex-col">
        ...
        <div className="flex items-center gap-2 px-4 h-16 border-b border-gray-200">
          <div className="w-7 h-7 rounded-lg bg-teal-800 flex items-center justify-center text-white text-xs font-bold">
            P
          </div>
          <span className="text-base font-semibold text-gray-900">Pennacle</span>
        </div>
